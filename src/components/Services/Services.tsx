    ...
    return (
      <Transition className="grid px-4 py-8 md:py-46 md:px-36 md:grid-cols-2 md:gap-28">
        <div className="max-w-xl mb-7">
          <h2 className="text-secondary font-bold flex items-center text-2xl">
            Servicios <BsPersonFillGear className="ml-1" />
          </h2>
          ...
          <p className="mb-10 mt-7">
            !En <span className="font-bold">Alfombrando</span>, tu hogar esta en
            las mejores manos! con Nuestros servicios de{" "}
            <span className="font-bold">Alta Calidad</span>. Ofrecemos limpieza
